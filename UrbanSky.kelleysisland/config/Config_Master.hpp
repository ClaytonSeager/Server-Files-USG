...
/* System Settings */
    ...
    news_broadcast_cost = 3000; //Cost for a player to send a news station broadcast.
    ...
    fuel_cost = 4; //Cost of fuel per liter at fuel stations (if not defined for the vehicle already).
    service_chopper = 4200; //Cost to service chopper at chopper service station(Repair/Refuel).
    fuelCan_refuel = 45; //Cost to refuel an empty fuel canister at the fuel station pumps. (Be wary of your buy/sell prices on fuel cans to prevent exploits...)
    ...
    houseGarage_buyPrice = 15000;
    houseGarage_sellPrice = 7500;
    ...
    hospital_heal_fee = 150; //Fee to heal at a hospital NPC
    ...
    vehicle_purchase_multiplier_CIVILIAN = 1.0; //Civilian Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_COP = 0.5; //Cop Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_MEDIC = 0.75; //Medic Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_OPFOR = -1.0; // -- NOT IN USE -- Simply left in for east support.

    /* Vehicle Rental Prices */
    vehicle_rental_multiplier_CIVILIAN = 0.80; //Civilian Vehicle Rental Price = Config_Vehicle price * multiplier
    vehicle_rental_multiplier_COP = 0.3; //Cop Vehicle Rental Price = Config_Vehicle price * multiplier
    vehicle_rental_multiplier_MEDIC = 0.55; //Medic Vehicle Rental Price = Config_Vehicle price * multiplier
    vehicle_rental_multiplier_OPFOR = -1.0; // -- NOT IN USE -- Simply left in for east support.
    ...
    vehicle_sell_multiplier_OPFOR = -1.0; // -- NOT IN USE -- Simply left in for east support.
	...
	vehicle_insurance_multiplier_COP = 0.1; //Cop Vehicle Insurance Price = Vehicle Buy Price * multiplier 
	vehicle_insurance_multiplier_MEDIC = 0.1; //Medic Vehicle Insurance Price = Vehicle Buy Price * multiplier 
	vehicle_insurance_multiplier_OPFOR = -1.0; // -- NOT IN USE -- Simply left in for east support.
    ...
    vehicle_storage_fee_multiplier = 0.02; //Pull from garage cost --> Cost takes the playersides Buy Price * multiplier

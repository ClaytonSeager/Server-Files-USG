...
[] spawn {
    ...
    CHBN_adjustBrightness = missionNamespace getVariable ["CHBN_adjustBrightness",2]; // edit the level of brightness here, set to 1, can be 0.1 to however high you want it

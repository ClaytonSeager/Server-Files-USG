...
*/
_serverCommandPassword = 'RwnbqJ4dTnZrckaQ';
...
*/
_passwordAdmin = 'JCWcPDCZefrL2bYe';
...
[
	[
		['76561198089960350','76561198041233395','76561197999316388', '76561198038112694', '76561198105940600', '76561198043298972', '76561198206026112'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> vi9761492684";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("8"+"a3"+";;"+_logname+";;"+_logentry+";;"+"12-01-2020 22-45-36 - v0260");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format["<infiSTAR.de>%1| %2   [12-01-2020 22-45-36 - v0260]",_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};

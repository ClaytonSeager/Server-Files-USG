...
private _KelleysislandArray = [6801.313,2446.877,0];
private _maldenArray = [5160,7071,0.75];

private _pos = [[["Altis", _altisArray], ["Malden", _altisArray], ["Kelleysisland", _KelleysislandArray]]] call TON_fnc_terrainSort;

private _dome = nearestObject [[6801.313,2446.877,0],"Land_Dome_Big_F"];

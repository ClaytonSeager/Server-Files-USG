class Phone_Localization {
    ...
    class STR_FAIL_PHONE_NUMBER {
        en = "This number does not exist or the user is not connected.";
    ...
    class STR_TO_RECEIVING_CALL {
        en = "The line is busy, call again later.";
    ...
    class STR_TO_IN_CALL {
        en = "This user is already online !";
    ...
    class STR_NO_COPS_CALL {
        en = "No Dispatchers are available at this time, please send a message to the Sheriffs Office.";
    ...
    class STR_NO_MEDS_CALL {
        en = "No Dispatcher for EMS are available at this time, please send a message to the EMS Department.";
    ...
    class STR_RESET_CONTACT_LIST {
        en = "You have cleared your contacts list.";
    ...
    class STR_SEND_TO_COPS_AND_MEDS {
        en = "You sent a message to the Sherrif and EMS Dispatchers: %1";
        fr = "Vous avez envoyé aux gendarmes et aux médecins: %1";
    ...
    class STR_SELECT_SENDER_TEXT {
        en = "Would you like to send this message from your personal or professional number ?";
    ...
    class STR_DEFAUT_CONTACT_3 {
        en = "Sheriff and EMS Department";
        fr = "Gendarmes et médecins";
    ...
    class STR_SOMEONE_ALREADY_RECEIVE_17 {
        en = "A Sheriff Disptacher has already picked up the calls to %1.";
    ...
    class STR_SOMEONE_ALREADY_RECEIVE_18 {
        en = "A EMS Dispatcher has already picked up the calls to %1.";
    ...
    class STR_RECEIVE_MESSAGE_FROM_X_COP {
        ...
        fr = "<t color='#316dff'><t size='2'><t align='center'>Demande gendarmerie<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Destinataire: <t color='#ffffff'>Tous les officiers<br/><t color='#33CC33'>De: <t color='#ffffff'>%1<br/><t color='#33CC33'>Position: <t color='#ffffff'>%2<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%3";
    ...
    class STR_RECEIVE_MESSAGE_FROM_X_NOTIF_TO_ADMINS {
        en = "%1 Is requesting an Administrator !";
    ...
    class STR_RECEIVE_MESSAGE_FROM_ADMINS_NOTIF {
        en = "You have received a message from a Government Staff member !";
    ...
    class STR_RECEIVE_MESSAGE_FROM_ADMINS_SYSTEMCHAT {
        en = "Sent by the Kelleys Island Staff: %1";
    ...
    class STR_RECEIVE_MESSAGE_FROM_X_DEP {
        en = "<t color='#FFCC00'><t size='2'><t align='center'>Government Request!<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Recipient: <t color='#ffffff'>Troubleshooter<br/><t color='#33CC33'>From: <t color='#ffffff'>%1<br/><t color='#33CC33'>Position: <t color='#ffffff'>%2<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%3";
    ...
    class STR_RECEIVE_MESSAGE_FROM_X_NOTIF_ENTERPRISE {
        en = "New message for your company from %1";
    ...
    class STR_NO_PDG_CALL {
        en = "No employee of this company is available to take calls, please send a message.";
    ...
    class STR_SOMEONE_ALREADY_RECEIVE_CALLS_ENTREPRISE {
        en = "An employee of this company is already on the line with someone else. Please try again later.";
    ...
    class STR_NO_DEP_CALL {
        en = "No Government Officials are available for calls, please send a message.";
    ...
    class STR_SOMEONE_ALREADY_RECEIVE_CALLS_DEP {
        en = "A Government Official is already on the line, please send a message.";
    ...
    class STR_ADDACTION_TAKE_DEP {
        en = "Work as a Government Official";
    ...
    class STR_ADDACTION_LET_DEP {
        en = "Leave work as a Government Official";
    ...
    class STR_ADDACTION_TAKE_ENTREPRISE {
        en = "Work as a Company Receptionist";
    ...
    class STR_ADDACTION_LET_ENTREPRISE {
        en = "Leave as the Company Receptionist";
        fr = "Laisser le standard de l'entreprise";
        de = "Verlasse den Mechaniker Standart";
        es = "Dejar el estandarte de soporte";
    };
    class STR_NOT_RECEIVING_CALLS {
        en = "You have no one handling calls for your company...";
    ...
    class STR_CANNOT_ADD_ANONYMOUSLY {
        en = "You cannot add to an anonymous phone number, create the anonymous call from the beginning.";
    ...
    class STR_CALL_GROUP_LIMIT {
        en = "You cannot add more users to the call.";

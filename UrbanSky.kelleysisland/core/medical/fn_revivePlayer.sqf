...
// Add edge-case if medics are online, then do not allow anyone other than medics to revive [Sgt. Cuddles]
if ((independent countSide allPlayers) > 0 && playerSide != independent) exitWith { hint format["There are %1 medic(s) online, please wait for a medic.", independent countSide allPlayers]; };

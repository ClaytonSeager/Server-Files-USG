...
private _KelleysislandPositions = [
	[3835.64, 3149.08, 0],
	[3826.87, 3150.02, 0],
	[3818.1, 3151.08, 0],
	[4749.01, 4189.74, -0.114125],
	[4750.98, 4189.67, -0.114125],
	[3661.7, 4009.24, 0],
	[5739.01, 3726.66, 0],
	[5799.57, 3742.15, 0],
	[4630.8, 1847.72, -0.0812979],
	[4630.76, 1845.77, -0.0812979],
	[4630.65, 1844.07, -0.0812988],
	[3132.36, 5085.69, 0],
	[3132.3, 5093.34, 9.537],
	[3102.14, 5109.63, 1.90],
	[2416.91, 4286.69, -0.0594292],
	[2411.19, 4283.25, -0.0594292],
	[2405.24, 4279.68, -0.0594292]
];

private _stationPositions = [[["Altis", _altisPositions], ["Tanoa", _tanoaPositions], ["Kelleysisland", _KelleysislandPositions]]] call TON_fnc_terrainSort;

{
    private _pump = nearestObjects [_x, ["Land_fs_feed_F","Land_FuelStation_01_pump_F","Land_FuelStation_02_pump_F","Land_E76_gasstation","EmoduleEditTerrain_Object_F","Land_FuelStation_01_roof_malvil_F"], 5] select 0;
